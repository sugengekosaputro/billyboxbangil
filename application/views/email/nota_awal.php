...
<table border="1" style="width:100%; border-collapse: collapse;">
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; "><?php echo 'Rp.'.number_format($pembayaran['harga_pesan']);?></td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px"></td>
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; background-color:yellow">DP Minimal <?php echo ($pembayaran['dp'] * 100) ?> %</td>
      <td style="border-bottom:1pt solid black; background-color:yellow"><?php echo 'Rp. '.number_format(($pembayaran['harga_pesan'] * $pembayaran['dp']));?></td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black;"></td>
          <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
      ...
      <td style="border:1pt solid white; border-top:1pt solid black;border-right:1pt solid white;padding-top:20px">
        <p><i style="color:red">NB:Total harga pembayaran dapat berubah sesuai barang yang dikirim</i></p>
        <p><i style="color:red">Dimohon untuk segera membayar DP agar mempercepat proses pengiriman</i></p>
      </td>
