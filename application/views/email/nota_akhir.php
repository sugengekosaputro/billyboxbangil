...
<table border="0"  style="width:100%;">
  <tr valign="top" align="left">
    ...
    <th style="width:40%;padding-top:5%;padding-bottom:1%;" align="center"><a style="font-size:20px"><u>Nota Pembelian</th>
...
<table border="0"  style="width:100%;">
  ...
  <tr valign="top">
    ...
    <td>Nota No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $order['id_order'];?></td> 
  </tr>
</table>
<br>
<table border="1" style="width:100%; border-collapse: collapse;">
  ...
  <tr  style="border-bottom:1pt solid white;" valign="top">
      <td style="border-bottom:1pt solid white; "><?php echo date('d-m-Y',strtotime($order['tanggal_order']));?></td>
      <td style="border-bottom:1pt solid white; " align="right"><?php echo $order['detail_order'][$i]['jumlah'];?></td>
      <td style="border-bottom:1pt solid white;" align="left"><?php // echo $list->satuan;?></td>
      <td style="border-bottom:1pt solid white; "><?php echo  $order['detail_order'][$i]['nama_barang'];?></td>
      <td style="border-bottom:1pt solid white; "><?php echo 'Rp. '.number_format($order['detail_order'][$i]['harga_satuan']);?></td>
      <td style="border-bottom:1pt solid white; "><?php echo 'Rp. '.number_format($order['detail_order'][$i]['harga']); ?></td>
  </tr>
  <?php } ?>
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; ">
        <?php if($pembayaran['harga_dikirim'] == null){
          echo 'Rp.'.number_format($pembayaran['harga_pesan']);
        }else{
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; "><?php echo 'Rp. '.number_format($pembayaran['sudah_dibayar']); ?></td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; background-color:yellow">Sisa Pembayaran</td>
      <td style="border-bottom:1pt solid black; background-color:yellow"><?php echo 'Rp. '.number_format(($pembayaran['sisa_pembayaran']));?></td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black;"></td>
          <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="left"></td>
      <td style="border:1pt solid white; border-top:1pt solid black;border-right:1pt solid white;padding-top:20px">
        <p><i style="color:red">due date : after delivery</i></p>
      </td>
...
<table border="0"  style="width:100%;">
  <tr valign="top" align="left">
    ...
    <th style="width:50%;padding-top:5%;padding-bottom:1%;" align="center"><a style="font-size:20px"><u>Nota Pembelian</th>
...
<table border="1" style="width:100%; border-collapse: collapse;">
  ...
  <tr  style="border-bottom:1pt solid white;" valign="top">
      ...
      <td style="border-bottom:1pt solid white; " align="right"><?php // echo $pembayaran['nota'][$j]['dikirim']; ?></td>
      <td style="border-bottom:1pt solid white;" align="left"><?php // // echo $list->satuan; ?></td>
      <td style="border-bottom:1pt solid white; "><?php // echo $pembayaran['nota'][$j]['nama_barang']; ?></td>
      <td style="border-bottom:1pt solid white; "><?php // echo 'Rp. '.number_format($pelanggan['harga_jual'][$j]['harga_jual']) ?></td>
      <td style="border-bottom:1pt solid white; "><?php // echo 'Rp. '.number_format(($pelanggan['harga_jual'][$j]['harga_jual'] * $pembayaran['nota'][$j]['dikirim'])); ?></td>
  </tr>
  <?php // }?>
  <tr valign="top" style="">
      <td style="border-top:1pt solid white; padding-top:50px">&emsp;</td>
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border:1pt solid white; border-top:1pt solid black;border-right:1pt solid black;">acc transf: bca 2250531306</td>
      <td style="border-bottom:1pt solid black; ">Jumlah</td>
      <td style="border-bottom:1pt solid black; "><?php // // echo 'Rp. '.number_format($pembayaran['harga_dikirim']); ?></td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px"></td>
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
