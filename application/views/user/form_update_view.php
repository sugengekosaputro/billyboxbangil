          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <?php echo form_open_multipart('user/update');?>
                ...
                <input type="hidden" name="foto_path" value="<?php echo $data['foto'] ?>">
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" name="username" class="form-control has-feedback-left" value="<?php echo $data['username'] ?>">
                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" name="email" class="form-control has-feedback-left" value="<?php echo $data['email'] ?>">
                    <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
                </div>
                
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="password" name="password" class="form-control has-feedback-left" value="<?php echo $data['password'] ?>">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback" style="padding-left:20%">
                    <img height="100px" src="<?php echo $data['foto'] ?>" weight="100px" id="viewfoto">
                </div>
