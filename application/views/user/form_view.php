            ...
            <div class="x_content">
              ...
              <!-- <form class="form-horizontal form-label-left input_mask" enctype="multipart/form-data" action="<?php //echo site_url('user/simpan')?>" method="POST"> -->
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" name="email" class="form-control has-feedback-left" id="inputSuccess5" placeholder="Email">
                ...
                <div class="form-group">
                  ...
                  <a class="btn btn-sm btn-default" href="<?php echo base_url('user'); ?>" type="button"> <span class="fa fa-arrow-left"></span> Kembali</a>
